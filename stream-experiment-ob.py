...
for n_components in used_features:
    ...
    plt.ylim(0, 1)
    plt.title("OB - PCA - %i" % n_components)

    plt.savefig("figures/OB-PCA_%i" % (n_components))
    plt.savefig("foo")

    np.save("results/OB-PCA_%i" % (n_components), eval.scores)
    ...
    plt.ylim(0, 1)
    plt.title("OB - CV - %i" % n_components)

    plt.savefig("figures/OB-CV_%i" % (n_components))
    plt.savefig("bar")

    np.save("results/OB-CV_%i" % (n_components), eval.scores)
    plt.clf()
    ...
    plt.ylim(0, 1)
    plt.title("OB - FS - %i" % n_components)

    plt.savefig("figures/OB-FS_%i" % (n_components))
    plt.savefig("baz")

    np.save("results/OB-FS_%i" % (n_components), eval.scores)
    plt.clf()
