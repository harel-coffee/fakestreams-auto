...
for n_components in used_features:
    ...
    plt.ylim(0, 1)
    plt.title("SEA-PCA - %i" % n_components)

    plt.savefig("figures/SEA-PCA_%i" % (n_components))
    plt.savefig("foo")

    np.save("results/SEA-PCA_%i" % (n_components), eval.scores)
    ...
    plt.ylim(0, 1)
    plt.title("SEA - CV - %i" % n_components)

    plt.savefig("figures/SEA-CV_%i" % (n_components))
    plt.savefig("bar")

    np.save("results/SEA-CV_%i" % (n_components), eval.scores)
    plt.clf()
    ...
    plt.ylim(0, 1)
    plt.title("SEA-FS - %i" % n_components)

    plt.savefig("figures/SEA-FS_%i" % (n_components))
    plt.savefig("baz")

    np.save("results/SEA-FS_%i" % (n_components), eval.scores)
    plt.clf()
